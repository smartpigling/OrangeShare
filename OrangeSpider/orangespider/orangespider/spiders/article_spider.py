...
from orangespider.utils import parse_text
from orangespider.items import Article
...
class ArticleSpider(CrawlSpider):
    ...
    def parse_item(self, response):
        ...
        article["publish_time"] = parse_text(
            publish_time, self.rule.name, 'publish_time')
